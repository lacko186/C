            ...
            if (adat == "4")
            {
                ...
                for (int i = 0; i < list.Count(); i++)
                {
                    ...
                    if (list[i].name == keres)
                    {
                        ...
                        list[i].address = uc;
                        list[i].phone = Convert.ToInt32(ut);
                        list[i].email = ue;
                    }
                }
